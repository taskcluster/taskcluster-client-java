...
public class GetSecretRequest {
	...
	/**
	 * List of strings which are scopes for temporary credentials to give to the
	 * worker through the secret system
	 */
	...
	/**
	 * A Slug ID which is the uniquely addressable token to access this set of
	 * secrets
	 */
	public String token;
