...
public class TaskStatusStructure {
	...
	public class Runs {
		...
		/**
		 * Reason for the creation of this run, **more reasons may be added in
		 * the future**."
		 */
		public Object reasonCreated;

		/**
		 * Reason that run was resolved, this is mainly useful for runs resolved
		 * as `exception`. Note, **more reasons may be added in the future**,
		 * also this property is only available after the run is resolved.
		 */
		 ...
		 * isn't reclaimed. Note, only present after the run has been claimed.
		 */
		public Date takenUntil;

		/**
		 * Identifier for group that worker who executes this run is a part of,
		 * this identifier is mainly used for efficient routing. Note, this
		 * property is only present after the run is claimed.
		 */
