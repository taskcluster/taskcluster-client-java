 ...
 *
 * See
 * http://schemas.taskcluster.net/scheduler/v1/inspect-task-graph-task-response.
 * json#
 */
public class InspectTaskGraphTaskResponse {

	/**
	 * List of `taskId`s that requires this task to be _complete successfully_
	 ...
	 * **Note**, this does not capture _retries_ due to infrastructure issues.
	 */
	public int reruns;
